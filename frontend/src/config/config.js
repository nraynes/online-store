...
export const topBarHeight = 3.5;
export const categoryBarHeight = 3;
...
export const commonFormOpacity = custom.commonFormOpacity || 1;
...
export const componentOpacity = custom.componentOpacity || 1;
